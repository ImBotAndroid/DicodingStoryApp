...
class StoryPagingSource(private val apiService: ApiService, private val bearer: String) : PagingSource<Int, ListStoryItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ListStoryItem> {
        return try {
            ...
            val responseData = apiService.getAllStories(bearer, page, params.loadSize)
            LoadResult.Page(
